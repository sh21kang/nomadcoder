"""
Django settings for nomad_coders project.
...
# (nomad_coders/config/settings/base.py - 3 = nomad_coders/)
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://postgres:michael21@localhost:5432/nomadgram'),
}
DATABASES['default']['PASSWORD'] = "michael21"
...
REST_AUTH_SERIALIZERS ={
    'USER_DETAILS_SERIALIZERS' : 'nomad_coders.users.serializers.UserProfileSerializer'
}
